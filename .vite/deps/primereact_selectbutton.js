...
var SelectButtonItem = React7.memo(function(props) {
  var _React$useState = React7.useState(false), _React$useState2 = _slicedToArray6(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var mergeProps2 = useMergeProps();
  ...
  var createContent = function createContent2() {
    ...
    return props.template ? ObjectUtils.getJSXElement(props.template, props.option) : React7.createElement("span", labelProps, props.label);
  };
  ...
  return React7.createElement("div", buttonProps, content, !props.disabled && React7.createElement(Ripple, null));
});
SelectButtonItem.displayName = "SelectButtonItem";
var SelectButton = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React7.useContext(PrimeReactContext);
  var props = SelectButtonBase.getProps(inProps, context);
  var _React$useState = React7.useState(0), _React$useState2 = _slicedToArray6(_React$useState, 2), focusedIndex = _React$useState2[0], setFocusedIndex = _React$useState2[1];
  ...
  var onOptionClick = function onOptionClick2(event) {
    ...
    var newValue;
    if (props.multiple) {
      var currentValue = props.value ? _toConsumableArray4(props.value) : [];
      newValue = selected ? currentValue.filter(function(val) {
        return !ObjectUtils.equals(val, optionValue, props.dataKey);
      }) : [].concat(_toConsumableArray4(currentValue), [optionValue]);
    } else {
  ...
  var createItems = function createItems2() {
    if (props.options && props.options.length) {
      return props.options.map(function(option, index) {
        ...
        return React7.createElement(SelectButtonItem, {
  ...
  return React7.createElement(React7.Fragment, null, React7.createElement("div", rootProps, items, props.children), hasTooltip && React7.createElement(Tooltip, _extends4({
    target: elementRef,
